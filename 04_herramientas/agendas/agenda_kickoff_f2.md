...
4. **Guías personalizadas de 14 días por participante:** `docs/fase2/` (HTML publicado) + Drive `F2_03_Sesiones_Material` (Google Docs editables) — cada participante recibe la suya en el kickoff
