...
2. **Carpeta compartida del piloto** — `https://drive.google.com/drive/folders/1LrA6qMsU_CEKIILhz8l5GBTBVUp4kM-g` como raíz (desde 18/08: "AI Fluency — Programa MCA 2026"; la carpeta F1 quedó archivada en `01_Fases/`); cada Champion con subcarpeta propia (evidencia S1/S2, conocimiento colectivo).
