...
- **Semana 1** (herramienta = Google Gemini, para las PRIMERAS actividades de aprendizaje — solución institucional ya disponible): D1 prompts (rol+tarea+contexto) + bloque de **NotebookLM del proyecto** (asistente de consulta oficial: https://notebook.google.com/notebook/47737000-b53d-42ad-93aa-1cc1ba0c9560) · D2 3 prompts reales del puesto · D3 contexto/memoria · D4 refinamiento · D5 nivel L2 (IA lee archivos del área) · D6 tabla de clasificación de activos (ISO 27001) · D7 caso real de la semana · D8 revisión con facilitador.
- **Semana 2**: D9 marcos (ITIL/COBIT — según el rol) · D10 LEAN (desperdicios, PDCA, línea base antes/después) · D11 introducción a **Hermes Agent (herramienta de trabajo del programa**: gestiona memory, tools, skills, profiles — portabilidad estandarizada del conocimiento) · D12 Hermes con caso real · D13 PRINCE2/agile (mini-proyecto) + medición delta · D14 entrega, reflexión, validación (facilitador + co-firma Douglas).
...
- Registrar aquí las lecciones aprendidas (ej. F2: usar funciones reales confirmadas, NO títulos RRHH; 14 días en vez de 7; Gemini en las primeras actividades de aprendizaje y Hermes Agent como herramienta de trabajo del programa — portabilidad del conocimiento vía memory/tools/skills/profiles; matiz de decisión 19/08).
