...
5. **Todo compromiso nuevo que exija evidencia de Champions nace equipado** (regla del 17/07): antes de anunciarlo deben existir (a) su **plantilla-rúbrica** en Drive (prefijo `_PLANTILLA_`, en la carpeta del entregable: instrucciones de copia/renombre, campos del criterio de aceptación, rúbrica de autoevaluación y bloque de veredicto del Director) y (b) la **ubicación exacta de entrega** declarada en la matriz de compromisos de `ESTADO_PROYECTO.md`. Sin plantilla y ubicación, el compromiso no se anuncia — un criterio que solo vive en la cabeza del Director o en una agenda es el patrón I1/I9 esperando repetirse. **Blindado por herramienta desde el 17/07** (tarde): `04_herramientas/check_consistencia.sh` (chequeo 6) falla si un compromiso EN CURSO que menciona a un Champion no cita `_PLANTILLA_` en su fila — ya no depende solo de disciplina editorial. Plantillas activas: C17 (guía de conocimiento colectivo), C18 (esquema Workspace), C19 (proceso medido), C20 (perfil de área), S2 (mini-reporte).
...
**✅ DECISIÓN TOMADA (18/08/2026, reestructura al cerrar F1):** la carpeta canónica única pasa a ser `1LrA6qMsU_CEKIILhz8l5GBTBVUp4kM-g` (**"AI Fluency — Programa MCA 2026"**), creada al archivar la Fase 1. La carpeta del 17/07 (`1eNbWpOmgatmQjOM5KZj6FNoA2CGR1kEj`) queda **archivada** (no obsoleta: su ID y links siguen funcionando) con nombre `F1_ARCHIVO — Piloto Champions (2026-06-26 a 2026-08-14)` y su propio README de vida cronológica, movida dentro de la nueva estructura en `01_Fases/`. Estructura nueva (18/08): `00_Gobernanza` · `01_Fases` (F1_ARCHIVO · F2_2026-08 a 2026-09 con 4 subcarpetas: Baseline_RESTRINGIDO, Evidencia_Participantes, Sesiones_Material, Cierre_y_Metricas_E8 · F3_2026-10 a 2026-11 placeholder · F4_2026-11 a 2026-12 placeholder) · `02_Conocimiento_Colectivo` · `03_Material_Programa` · `04_Comunicaciones` — con README de reglas y mapa de fases en la raíz. Los links viejos de la carpeta F1 archivada siguen siendo válidos (el ID no cambió al renombrar/mover).
