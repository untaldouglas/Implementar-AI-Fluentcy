...
| Gemini + Workspace | Herramienta estándar del programa (decisión 19/08): la universidad ya la tiene en su contrato Workspace for Education; reemplaza a Claude/Copilot como estándar. | Todas las guías F2 practican primero con Gemini (D1–D10) y usan Hermes como complemento (D11–D13). | Douglas | 19/08/2026 |
