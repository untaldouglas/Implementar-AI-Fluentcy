...
**Uso:** copia pre-llenada para la coordinación **Sistemas**. Confirmar KPI y responsables en D7 (reunión de planificación F2) y actualizar en cada medición.
...
| Responsable de medir | Jorge López (jelopezr@ujmd.edu.sv) |
| Participante(s) vinculado(s) | Jorge López (coordinador) · Bryan Gómez (Sistemas) |
...
| Campo | Valor |
|---|---|
| KPI | Tiempo de resolución de ticket (apertura → cierre) *(candidato sugerido — confirmar en D7)* |
| Definición operativa (qué se cuenta exactamente) | Tiempo transcurrido entre la apertura y el cierre de un ticket de mesa de ayuda, en horas hábiles |
| Unidad | horas/ticket |
| Fórmula | suma(tiempo cierre − tiempo apertura) / nº de tickets |
| Fuente de datos | ERPNext (mesa de ayuda) |
