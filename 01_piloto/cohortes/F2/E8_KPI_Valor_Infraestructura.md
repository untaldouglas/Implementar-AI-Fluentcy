...
**Uso:** copia pre-llenada para la coordinación **Infraestructura**. Confirmar KPI y responsables en D7 (reunión de planificación F2) y actualizar en cada medición.
...
| Responsable de medir | Luis Molina (lamolinaq@ujmd.edu.sv) |
| Participante(s) vinculado(s) | Luis Molina (coordinador) · Betty Figueroa (Sistemas → acompaña a Infraestructura) |
...
| Campo | Valor |
|---|---|
| KPI | Tiempo de alta/baja de cuentas AD *(candidato sugerido — confirmar en D7)* |
| Definición operativa (qué se cuenta exactamente) | Tiempo transcurrido entre la solicitud de alta o baja de una cuenta AD y su ejecución confirmada, en minutos |
| Unidad | minutos/caso |
| Fórmula | suma(tiempo por caso) / nº de casos del período |
| Fuente de datos | AD + registro manual (evidencia: capturas/bitácora) |
