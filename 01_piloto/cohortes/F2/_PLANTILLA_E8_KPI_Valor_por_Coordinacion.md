...
**Uso:** una copia POR COORDINACIÓN (Infraestructura · Desarrollo · Sistemas). Se llena en la reunión de planificación F2 y se actualiza en cada medición.
...
| Campo | Valor |
|---|---|
| Coordinación | [Infraestructura / Desarrollo / Sistemas] |
| Responsable de medir | [nombre + email] |
| Participante(s) vinculado(s) | [nombres] |
| Fecha de creación | [AAAA-MM-DD] |
| Fecha de línea base (medición ANTES) | [AAAA-MM-DD] |
| Fecha de medición DESPUÉS | [AAAA-MM-DD] |
| Estado | [🟡 línea base / 🔵 midiendo / 🟣 cerrado] |
...
| Campo | Valor |
|---|---|
| KPI | [elegir uno del catálogo, sección 6] |
| Definición operativa (qué se cuenta exactamente) | [ej.: "tiempo transcurrido entre la apertura y el cierre de un ticket de mesa de ayuda, en horas hábiles"] |
| Unidad | [horas / minutos / % / días / costo $] |
| Fórmula | [ej.: suma(tiempo cierre − tiempo apertura) / nº de tickets] |
| Fuente de datos | [ERPNext · Google Workspace · AD · registro manual · otra] |
| Meta del ciclo F2 | [ej.: −30% vs. línea base] |
...
| Campo | Acuerdo |
|---|---|
| Quién mide la línea base | [nombre] |
| Quién mide el después | [nombre] |
| Frecuencia de medición | [semanal / quincenal / mensual] |
| Dónde se registra | [tablero del programa · este archivo · informe E8] |
| Cuándo se revisa con Douglas | [fecha(s) de check-in] |
| Cuándo se presenta ante la Dirección | [Demo Day F2 — fecha] |
